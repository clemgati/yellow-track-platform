package com.yellowtrack.platform.feature.dashboard.presentation.sample
...
internal object DashboardSampleData {
    val summary =
        DashboardSummary(
            ...
            recentClients =
                listOf(
                    DashboardClient(name = "Emily Davis"),
                    DashboardClient(name = "Michael Brown"),
                    DashboardClient(name = "Jane Doe"),
                ),
            studioStatus =
